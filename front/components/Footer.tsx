        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://github.com/Princeimao/code-ladder" className="w-10 h-10 rounded-full bg-zinc-900 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white hover:border-white/20 transition-all">
                <Github size={20} />
              </a>
              <a href="https://www.linkedin.com/in/princeimao" className="w-10 h-10 rounded-full bg-zinc-900 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white hover:border-white/20 transition-all">
                <Linkedin size={20} />
              </a>
            </div>
          </div>
