...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden pt-20 bg-black">
      ...
      <div className="max-w-7xl mx-auto px-4 text-center relative z-20 pointer-events-none">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="inline-flex items-center gap-2 px-3 z-20 py-1 rounded-full bg-indigo-500/10 backdrop-blur-md border border-indigo-500/20 text-[10px] font-bold tracking-widest uppercase text-indigo-400 mb-8"
        >
